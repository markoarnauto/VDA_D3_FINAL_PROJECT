---
title: "High Fidelity High Frequency Trading Data (Viktor Ludwig, Markus Tretzmüller, Michael Trimmel)"
author: "Michael Trimmel ( a1449701 )"
date: "12 12 2016"
output: pdf_document
---
...
plot(dataM[,'Time'], dataM[,'Price'], type = "l", lwd=0.1, xlab="Time", ylab = "Price")
title(main="Price")
```
